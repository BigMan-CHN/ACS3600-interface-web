#include "CGetWebMICWhineButton.h"
#include <boost/lexical_cast.hpp>

CGetWebMICWhineButton::CGetWebMICWhineButton(string ip, int port, int timeOut)
...
bool CGetWebMICWhineButton::ComposeResult(cJSON *result)
{
...
string CGetWebMICWhineButton::ComposeResult()
{
...
bool CGetWebMICWhineButton::GetWebMICWhineButtonInner(CData& oResult, char* cResult, int ChnNam)
{
...
InterfaceResCode CGetWebMICWhineButton::GetWebMICWhineButton(string &sResult)
{
    //TODO
    mLogInfo("GetWebMICWhineButton...");
		...
		int ChnNum = 14;
		//1. 调用类内部方法进一步封装业务请求
		if (!GetWebMICWhineButtonInner(oResult, cResult, ChnNum))
		{
