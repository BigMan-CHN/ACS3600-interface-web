...
public:
     ...
     * @return 0：成功，!0：失败.
     */
    InterfaceResCode SetOsdCtrlStart(string &sResult,int OsdMode,int ChannelID,string Title);
...
private:
     ...
     * @return true：成功，false：失败.
     */
    bool SetOsdStart(int OsdMode,int ChannelID,string Title, CData &oResult, char *cResult);
