...
public:
     ...
     * @return 0：成功，!0：失败.
     */
    InterfaceResCode SendSerialCmd(string &sResult,  double Val, int ChnNum, int CtrlType);
private:
    /**
     ...
     * @return true：成功，false：失败.
     */
    bool SetSerialConfig( double Val, int ChnNum, int CtrlType, CData &oResult, char *cResult);
