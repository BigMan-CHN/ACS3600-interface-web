#ifndef GetWebStartAutoRec_H
#define GetWebStartAutoRec_H
/********************************************************
...
class CGetWebStartAutoRec
{
public:
    CGetWebStartAutoRec(string ip=MPS_IP, int port=MPS_PORT, int timeOut=MPS_TIMEOUT);
