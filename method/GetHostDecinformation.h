#ifndef GetHostDecinformation_H
#define GetHostDecinformation_H
/********************************************************
...
class CGetHostDecinformation
{
public:
    CGetHostDecinformation(string ip=MPS_IP, int port=MPS_PORT, int timeOut=MPS_TIMEOUT);
     ...
     * @return 0：成功，!0：失败.
     */
    InterfaceResCode GetHostDecinformation(string &sResult,int RtspNum);
	InterfaceResCode GetWebDecInfo(string &sResult);
...
private:
	...
	bool GetWebDecInfoInner(CData &oResult, char *cResult);
