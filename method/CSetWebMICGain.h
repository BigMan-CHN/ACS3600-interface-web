#ifndef SetWebMICGain_H
#define SetWebMICGain_H
/********************************************************
...
class CSetWebMICGain
{
public:
    CSetWebMICGain(string ip=MPS_IP, int port=MPS_PORT, int timeOut=MPS_TIMEOUT);
     ...
     * @return 0：成功，!0：失败.
     */
    InterfaceResCode SetWebMICGain(string &sResult,int MicVal, int ChnNam);
