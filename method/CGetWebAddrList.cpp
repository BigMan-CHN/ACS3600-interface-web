#include "CGetWebAddrList.h"
#include <boost/lexical_cast.hpp>

CGetWebAddrList::CGetWebAddrList(string ip, int port, int timeOut)
...
bool CGetWebAddrList::ComposeResult(cJSON *result)
{
...
string CGetWebAddrList::ComposeResult()
{
...
InterfaceResCode CGetWebAddrList::GetWebAddrList(string &sResult)
{
    //TODO
