#ifndef SetWebStartAutoRec_H
#define SetWebStartAutoRec_H
/********************************************************
...
class CSetWebStartAutoRec
{
public:
    CSetWebStartAutoRec(string ip=MPS_IP, int port=MPS_PORT, int timeOut=MPS_TIMEOUT);
