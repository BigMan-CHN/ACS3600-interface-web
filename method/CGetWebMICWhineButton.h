#ifndef GetWebMICWhineButton_H
#define GetWebMICWhineButton_H
/********************************************************
...
class CGetWebMICWhineButton
{
public:
    CGetWebMICWhineButton(string ip=MPS_IP, int port=MPS_PORT, int timeOut=MPS_TIMEOUT);
     ...
     * @return 0：成功，!0：失败.
     */
    InterfaceResCode GetWebMICWhineButton(string &sResult);
